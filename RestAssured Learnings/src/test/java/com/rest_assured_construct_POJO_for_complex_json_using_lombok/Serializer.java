...
public class Serializer {
	...
	// The main use of lombok is to avoid generating getters and setters(boiler plate codes) manually 
	// Lombok is providing annotations so that no need to implement manually only need to add annotations
	// check Outline before and after setting lombok annotations
	// To install Lombok go to https://projectlombok.org/setup/maven and in this page copy maven dependency in your project pom.xml
	// And go to https://projectlombok.org/download download the jar file and double click and it will automatically show preference for downloading it in eclipse
	// After installation restart Eclipse IDE 
	...
	public static void main(String[] args) throws StreamWriteException, DatabindException, IOException {
		...
		File json = new File("complex_json_using_lombok.json");
